...
export async function analyzeCurrencyStrengths(
  ...
  const systemPrompt = `En tant qu'expert en analyse des marchés Forex, analysez les actualités fournies pour évaluer la force relative des principales cryptomonnaies.
